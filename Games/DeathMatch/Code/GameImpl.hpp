...
namespace GAME_NAME
{
    ...
    class GameImplT : public cf::GameSys::GameI
    {
        ...
        IntrusivePtrT<GameEntityI> CreateGameEntity(const cf::TypeSys::TypeInfoT* TI, IntrusivePtrT<cf::GameSys::EntityT> Entity, const std::map<std::string, std::string>& Properties, const cf::SceneGraph::GenericNodeT* RootNode, const cf::ClipSys::CollisionModelT* CollisionModel, unsigned long ID, cf::GameSys::GameWorldI* GameWorld, const Vector3T<double>& Origin);
