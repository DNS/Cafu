...
EntWeaponShotgunT::EntWeaponShotgunT(const EntityCreateParamsT& Params)
    : EntWeaponT(Params, "Games/DeathMatch/Models/Weapons/Shotgun_w.mdl")
{
}
...
void EntWeaponShotgunT::NotifyTouchedBy(BaseEntityT* Entity)
{
    ...
    if (!cf::GameSys::GameImplT::GetInstance().GetCarriedWeapon(WEAPON_SLOT_SHOTGUN)->ServerSide_PickedUpByEntity(Entity)) return;
