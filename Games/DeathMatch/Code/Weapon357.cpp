...
EntWeapon357T::EntWeapon357T(const EntityCreateParamsT& Params)
    : EntWeaponT(Params, "Games/DeathMatch/Models/Weapons/DesertEagle_w.mdl")
{
}
...
void EntWeapon357T::NotifyTouchedBy(BaseEntityT* Entity)
{
    ...
    if (!cf::GameSys::GameImplT::GetInstance().GetCarriedWeapon(WEAPON_SLOT_357)->ServerSide_PickedUpByEntity(Entity)) return;
