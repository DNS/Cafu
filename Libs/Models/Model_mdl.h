...
WATCOM_PACKED struct StudioHeaderT
{
    ...
    ModelMdlT::Vec3T EyePosition;           // ideal eye position
    ModelMdlT::Vec3T Min;                   // ideal movement hull size
    ModelMdlT::Vec3T Max;

    ModelMdlT::Vec3T BBMin;                 // clipping bounding box
    ModelMdlT::Vec3T BBMax;
...
WATCOM_PACKED struct StudioSequenceT
{
    ...
    int              MotionType;
    int              MotionBone;
    ModelMdlT::Vec3T LinearMovement;
    int              AutoMovePosIndex;
    int              AutoMoveAngleIndex;

    ModelMdlT::Vec3T BBMin;                 // per sequence bounding box
    ModelMdlT::Vec3T BBMax;
...
WATCOM_PACKED struct StudioAttachmentT
{
    ...
    int              Type;
    int              Bone;
    ModelMdlT::Vec3T Org;   // attachment point
    ModelMdlT::Vec3T Vectors[3];
} GCC_PACKED;
