...
{
    // The GL_ARB_texture_cube_map_AVAIL query in the next line is only because the OpenGL 1.2 renderer
    ...
    // Thus, the "&& GL_ARB_texture_cube_map_AVAIL" is only required for the OpenGL 1.2. renderer and
