...
class Shader_A_Diff_Light_Norm_Spec : public ShaderT
{
    private:
    ...
    {
        static const std::string Name="A_Diff_Light_Norm_Spec";
...
static Shader_A_Diff_Light_Norm_Spec MyShader;
