...
class Shader_A_Diff : public ShaderT
{
    private:
    ...
    void Initialize()
    {
        ...
        FragmentProgram=UploadProgram(GL_FRAGMENT_PROGRAM_ARB,
            ...
            "MUL result.color, diff_col, fragment.color;            \n"     // result.color = tex2D(texture[0] at texcoord[0]) * fragment.color;
            "END                                                    \n");
    }
    ...
    {
        static const std::string Name="A_Diff";
