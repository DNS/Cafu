...
/// OpenAL implementation of the sound object.
...
class SoundImplT : public SoundI
{
    ...
    /// Destructor. Deletes the sound object by removing it from its current mixer track (if any) and sound buffer.
    ~SoundImplT();
    ...
    MixerTrackT*        MixerTrack;     ///< The mixertrack on which this sound object is played.
