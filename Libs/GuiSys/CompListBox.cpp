...
const cf::TypeSys::TypeInfoT ComponentListBoxT::TypeInfo(GetComponentTIM(), "GuiSys::ComponentListBoxT", "GuiSys::ComponentBaseT", ComponentListBoxT::CreateInstance, MethodsList, DocClass, DocMethods, DocVars);
