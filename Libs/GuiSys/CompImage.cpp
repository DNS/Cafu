...
const cf::TypeSys::TypeInfoT ComponentImageT::TypeInfo(GetComponentTIM(), "GuiSys::ComponentImageT", "GuiSys::ComponentBaseT", ComponentImageT::CreateInstance, MethodsList, DocClass, DocMethods, DocVars);
