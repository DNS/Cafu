...
const cf::TypeSys::TypeInfoT ComponentRadiosityLightT::TypeInfo(GetComponentTIM(), "ComponentRadiosityLightT", "ComponentLightT", ComponentRadiosityLightT::CreateInstance, MethodsList, DocClass, DocMethods, DocVars);
