...
const cf::TypeSys::TypeInfoT ComponentTargetT::TypeInfo(GetComponentTIM(), "GameSys::ComponentTargetT", "GameSys::ComponentBaseT", ComponentTargetT::CreateInstance, MethodsList, DocClass, DocMethods, DocVars);
