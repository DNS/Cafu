/**
 * @defgroup mapEntities Map Entities
 *
 * This module groups all script classes for the \emph{DeathMatch} example game that ships with Cafu.
 *
