...
#ifndef CAFU_GUIEDITOR_EDITOR_EDIT_WINDOW_HPP_INCLUDED
#define CAFU_GUIEDITOR_EDITOR_EDIT_WINDOW_HPP_INCLUDED
...
namespace GuiEditor
{
    class EditorEditWindowT : public EditorWindowT
    {
        ...
        /// The constructor.
        EditorEditWindowT(IntrusivePtrT<cf::GuiSys::EditWindowT> EditWindow, GuiDocumentT* GuiDoc);
        ...
        IntrusivePtrT<cf::GuiSys::EditWindowT> m_EditWindow;
    };
}
