...
class StdOutput : public CmdLineOutput
{
  public:
     ...
     */
    void usage(const CmdLineInterface& c) const override;
     ...
     * \param c - The CmdLine object the output is generated for.
     */
    void version(const CmdLineInterface& c) const override;
  ...
  protected:
     ...
     */
    void _shortUsage(const CmdLineInterface& c, std::ostream& os ) const;
     ...
     * \param os - The stream to write the message to.
     */
    void _longUsage(const CmdLineInterface& c, std::ostream& os ) const;
...
inline void
StdOutput::_shortUsage(const CmdLineInterface& _cmd,
...
inline void
StdOutput::_longUsage(const CmdLineInterface& _cmd,
                       std::ostream& os ) const
{
    std::list<Arg*> argList = _cmd.getArgList();
