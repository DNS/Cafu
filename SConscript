...
envCaWE.Append(LIBS=Split("SceneGraph MatSys ClipSys cfsLib ModelLoaders cfs_jpeg assimp bulletcollision expat noise lua minizip pcre lightwave freetype png z"))
